import shadeColor, { shadeColor2 } from './shadeColor'
...
const getColor = ({
  ...
  'inputValidation.errorBackground': color2,
  'inputValidation.errorBorder': color2,
  'inputValidation.infoBackground': color1,
  'inputValidation.infoBorder': color1,
  'inputValidation.warningBackground': color5,
  'inputValidation.warningBorder': color5,
  ...
  'editorOverviewRuler.errorForeground': color2,
  'editorOverviewRuler.modifiedForeground': color4,
  'editorOverviewRuler.warningForeground': color5,
  'editorError.foreground': color2,
  ...
  'diffEditor.insertedTextBackground': `${color3}25`,
  'diffEditor.insertedTextBorder': `${color3}25`,
  'diffEditor.removedTextBackground': `${color2}25`,
  'diffEditor.removedTextBorder': `${color2}25`,
  ...
  'debugExceptionWidget.border': color1,
  'editorMarkerNavigation.background': background,
  'editorMarkerNavigationError.background': color2,
  'editorMarkerNavigationWarning.background': color5,
  ...
  'notification.warningBackground': color5,
  'notification.warningForeground': background,
  'notification.errorBackground': color2,
  ...
  'gitDecoration.modifiedResourceForeground': color4,
  'gitDecoration.deletedResourceForeground': color2,
  'gitDecoration.untrackedResourceForeground': color3,
